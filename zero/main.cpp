...
static unsigned int gColorIndex = 0;
static unsigned int gnNumColors = 4;
...
void drawScene(void)
{
    ...
    glMaterialfv(GL_FRONT_AND_BACK, GL_AMBIENT_AND_DIFFUSE, diffColors[gColorIndex % gnNumColors]);
